...
var (
	md_NextLoanIndex       protoreflect.MessageDescriptor
	fd_NextLoanIndex_index protoreflect.FieldDescriptor
)
...
var _ protoreflect.Message = (*fastReflection_NextLoanIndex)(nil)

type fastReflection_NextLoanIndex NextLoanIndex

func (x *NextLoanIndex) ProtoReflect() protoreflect.Message {
	return (*fastReflection_NextLoanIndex)(x)
}
...
var _fastReflection_NextLoanIndex_messageType fastReflection_NextLoanIndex_messageType
var _ protoreflect.MessageType = fastReflection_NextLoanIndex_messageType{}

type fastReflection_NextLoanIndex_messageType struct{}

func (x fastReflection_NextLoanIndex_messageType) Zero() protoreflect.Message {
	return (*fastReflection_NextLoanIndex)(nil)
}
func (x fastReflection_NextLoanIndex_messageType) New() protoreflect.Message {
	return new(fastReflection_NextLoanIndex)
}
func (x fastReflection_NextLoanIndex_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_NextLoanIndex
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_NextLoanIndex) Descriptor() protoreflect.MessageDescriptor {
	return md_NextLoanIndex
}
...
func (x *fastReflection_NextLoanIndex) Type() protoreflect.MessageType {
	return _fastReflection_NextLoanIndex_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_NextLoanIndex) New() protoreflect.Message {
	return new(fastReflection_NextLoanIndex)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_NextLoanIndex) Interface() protoreflect.ProtoMessage {
	return (*NextLoanIndex)(x)
}
...
func (x *fastReflection_NextLoanIndex) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Index != int64(0) {
		value := protoreflect.ValueOfInt64(x.Index)
		if !f(fd_NextLoanIndex_index, value) {
			return
		}
	}
}
...
func (x *fastReflection_NextLoanIndex) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "kopi.mm.NextLoanIndex.index":
		return x.Index != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: kopi.mm.NextLoanIndex"))
		}
		panic(fmt.Errorf("message kopi.mm.NextLoanIndex does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_NextLoanIndex) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "kopi.mm.NextLoanIndex.index":
		x.Index = int64(0)
	default:
...
func (x *fastReflection_NextLoanIndex) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message kopi.mm.NextLoanIndex does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_NextLoanIndex) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "kopi.mm.NextLoanIndex.index":
		x.Index = value.Int()
	default:
...
func (x *fastReflection_NextLoanIndex) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "kopi.mm.NextLoanIndex.index":
		panic(fmt.Errorf("field index of message kopi.mm.NextLoanIndex is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: kopi.mm.NextLoanIndex"))
		}
...
func (x *fastReflection_NextLoanIndex) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "kopi.mm.NextLoanIndex.index":
...
func (x *fastReflection_NextLoanIndex) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in kopi.mm.NextLoanIndex", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_NextLoanIndex) GetUnknown() protoreflect.RawFields {
...
func (x *fastReflection_NextLoanIndex) SetUnknown(fields protoreflect.RawFields) {
...
func (x *fastReflection_NextLoanIndex) IsValid() bool {
	return x != nil
}
...
func (x *fastReflection_NextLoanIndex) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*NextLoanIndex)
		if x == nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: NextLoanIndex: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: NextLoanIndex: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *NextLoanIndex) String() string {
