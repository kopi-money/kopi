...
type DenomLoanData struct {
	...
	BorrowAmount cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=borrow_amount,json=borrowAmount,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"borrow_amount"`
}

func (m *DenomLoanData) Reset()         { *m = DenomLoanData{} }
func (m *DenomLoanData) String() string { return proto.CompactTextString(m) }
func (*DenomLoanData) ProtoMessage()    {}
func (*DenomLoanData) Descriptor() ([]byte, []int) {
	return fileDescriptor_4377270a8991865d, []int{2}
}
func (m *DenomLoanData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DenomLoanData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DenomLoanData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DenomLoanData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DenomLoanData.Merge(m, src)
}
func (m *DenomLoanData) XXX_Size() int {
	return m.Size()
}
func (m *DenomLoanData) XXX_DiscardUnknown() {
	xxx_messageInfo_DenomLoanData.DiscardUnknown(m)
}

var xxx_messageInfo_DenomLoanData proto.InternalMessageInfo

func (m *DenomLoanData) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *DenomLoanData) GetLoans() []*Loan {
	if m != nil {
		return m.Loans
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DenomLoanData)(nil), "kopi.mm.DenomLoanData")
}
...
var fileDescriptor_4377270a8991865d = []byte{
	...
	,
}
...
func (m *DenomLoanData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DenomLoanData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DenomLoanData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DenomLoanData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DenomLoanData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DenomLoanData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DenomLoanData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
