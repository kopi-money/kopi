...
type Collaterals struct {
	...
	Collaterals []Collateral `protobuf:"bytes,2,rep,name=collaterals,proto3" json:"collaterals"`
}
...
func (m *GenesisCollateral) Reset()         { *m = GenesisCollateral{} }
func (m *GenesisCollateral) String() string { return proto.CompactTextString(m) }
...
func (m *GenesisCollateral) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GenesisCollateral) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GenesisCollateral.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GenesisCollateral) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenesisCollateral.Merge(m, src)
}
func (m *GenesisCollateral) XXX_Size() int {
	return m.Size()
}
func (m *GenesisCollateral) XXX_DiscardUnknown() {
	xxx_messageInfo_GenesisCollateral.DiscardUnknown(m)
}

var xxx_messageInfo_GenesisCollateral proto.InternalMessageInfo

func (m *GenesisCollateral) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *GenesisCollateral) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GenesisCollateral)(nil), "kopi.mm.GenesisCollateral")
}
...
var fileDescriptor_dfc58facdac8b1dd = []byte{
	...
	0x79, 0x25, 0x41, 0x50, 0xc5, 0x4a, 0x09, 0x5c, 0xdc, 0x08, 0xe3, 0x8b, 0x85, 0x44, 0xb8, 0x58,
	0x53, 0x52, 0xf3, 0xf2, 0x73, 0xa1, 0xa6, 0x43, 0x38, 0x42, 0xd6, 0x5c, 0xdc, 0x08, 0x67, 0x17,
	0x4b, 0x30, 0x29, 0x30, 0x6b, 0x70, 0x1b, 0x09, 0xeb, 0x41, 0x1d, 0xae, 0x87, 0x30, 0xc0, 0x89,
	0x05, 0x64, 0x6b, 0x10, 0xb2, 0x6a, 0xa5, 0x2a, 0x2e, 0x41, 0xf7, 0xd4, 0xbc, 0xd4, 0xe2, 0xcc,
	0x62, 0x24, 0x7f, 0x60, 0xb7, 0x07, 0xc9, 0x77, 0x4c, 0xb8, 0x7c, 0xc7, 0x4c, 0x82, 0xef, 0x9c,
	...
	0xa3, 0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0x1f, 0xe4, 0x0f, 0xdd, 0xdc, 0xfc, 0xbc, 0xd4, 0x4a,
	0x30, 0x53, 0xbf, 0x02, 0x14, 0x4f, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0x48, 0x30,
	0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x60, 0x69, 0xac, 0x72, 0xbf, 0x01, 0x00, 0x00,
}
...
func (m *GenesisCollateral) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GenesisCollateral) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GenesisCollateral) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GenesisCollateral) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GenesisCollateral) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GenesisCollateral: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GenesisCollateral: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
