...
type GenesisLoans struct {
	...
	Loans     []GenesisLoan               `protobuf:"bytes,4,rep,name=loans,proto3" json:"loans"`
}

func (m *GenesisLoans) Reset()         { *m = GenesisLoans{} }
func (m *GenesisLoans) String() string { return proto.CompactTextString(m) }
func (*GenesisLoans) ProtoMessage()    {}
func (*GenesisLoans) Descriptor() ([]byte, []int) {
	return fileDescriptor_83af339b64d6baef, []int{2}
}
func (m *GenesisLoans) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GenesisLoans) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GenesisLoans.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GenesisLoans) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenesisLoans.Merge(m, src)
}
func (m *GenesisLoans) XXX_Size() int {
	return m.Size()
}
func (m *GenesisLoans) XXX_DiscardUnknown() {
	xxx_messageInfo_GenesisLoans.DiscardUnknown(m)
}

var xxx_messageInfo_GenesisLoans proto.InternalMessageInfo

func (m *GenesisLoans) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *GenesisLoans) GetLoans() []GenesisLoan {
	if m != nil {
		return m.Loans
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GenesisLoans)(nil), "kopi.mm.GenesisLoans")
...
var fileDescriptor_83af339b64d6baef = []byte{
	...
	,
}
...
func (m *GenesisLoans) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GenesisLoans) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GenesisLoans) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GenesisLoans) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GenesisLoans) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GenesisLoans: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GenesisLoans: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
