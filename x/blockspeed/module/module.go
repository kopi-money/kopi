...
import (
	...
	modulev1 "github.com/kopi-money/kopi/api/kopi/blockspeed/module"
...
func (am AppModule) BeginBlock(ctx context.Context) error {
	if err := am.keeper.Initialize(ctx); err != nil {
		return fmt.Errorf("initialize blockspeed module: %w", err)
	}
...
type ModuleOutputs struct {
	...
	BlockspeedKeeper keeper.Keeper
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{BlockspeedKeeper: k, Module: m}
}
