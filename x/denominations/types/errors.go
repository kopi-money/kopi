...
var (
	...
	ErrInvalidDexAsset         = sdkerrors.Register(ModuleName, 1101, "given denom is no dex denom")
	...
	ErrInvalidFactoryPoolDenom = sdkerrors.Register(ModuleName, 1110, "given denom is no factory pool denom")
)
