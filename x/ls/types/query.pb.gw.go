...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"kopi", "ls", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Undelegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"kopi", "ls", "undelegations"}, "", runtime.AssumeColonVerbOpt(false)))
)
